...
export default function Room() {
    ...
    // Store frame data for segmentation (Person B)
    ...
    useEffect(() => {
        ...
        const initPeer = async () => {
            ...
            peer.on("open", (id) => {
                ...
                // Person A: nothing extra to do here until someone calls
            });
